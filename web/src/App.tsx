      ...
      <header>
        <div className="nav-wrapper">
          <div className="logo-section" onClick={() => setActiveTab('intro')}>
            <img src="/toolshield_icon.png" alt="ToolShield" className="logo-icon" />
          ...
          >
            <svg height="16" viewBox="0 0 16 16" width="16" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
